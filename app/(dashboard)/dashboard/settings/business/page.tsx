  ...
  return (
    <div className="px-6 py-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white">Información del negocio</h1>
          <p className="text-sm text-[#64748b] mt-0.5">Dirección, contacto y redes sociales</p>
        </div>
      </div>
      <BusinessEditor tenant={tenant} />
    </div>
  )
}
